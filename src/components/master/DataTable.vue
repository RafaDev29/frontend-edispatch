<template>
  ...
  import { listMasterApi } from '@/api/MasterService';
  ...
  export default {
    ...
    setup() {
      ...
      const isEditFormVisible = ref(false); // Controla la visibilidad del formulario de edición
      const selectedMaster = ref(null); // Master seleccionado para editar
      ...
      const openEditForm = (item) => {
        selectedMaster.value = item; // Asigna el master seleccionado
