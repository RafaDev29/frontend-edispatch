<template>
  <div class="flex items-center justify-center min-h-screen bg-[#130f23] p-4">
    <div class="w-full max-w-md bg-transparent shadow-none p-6">
      ...
      <h1 class="text-lg text-[#fc844c] text-center mb-4 font-bold">¡Bienvenido de nuevo!</h1>
      <p class="text-xs text-gray-400 text-center mb-4">
        Ingresa las credenciales que le brindó su proveedor
      </p>
      ...
      <div class="mt-8 text-gray-400 text-[9.8px] text-center">
