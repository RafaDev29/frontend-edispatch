<template>
  <v-card>
    <v-layout>
      <v-navigation-drawer v-if="!isCamposGeneralesView" v-model="drawer" :rail="rail" permanent @click="rail = false"
        color="#180c24" class="border-0">
...
.selected-item-orange {
  ...
  /* Fondo con color #ff8c54 */
  color: white !important;
  /* Texto en blanco */
  border-right: 4px solid #e20303;
  /* Borde derecho más oscuro para contraste */
}
