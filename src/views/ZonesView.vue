<template>
    ...
    <div class="pt-0 mt-0 pb-10 ml-0 mr-0 min-w-max[100%]">
      <div>
        <div class="flex justify-between items-center mb-2 bg-gray-50 p-6 rounded-lg shadow-lg">
                  ...
                  <h1 class="font-bold lg:text-2xl text-xl text-indigo-900 " >      <span class="mdi mdi-map"></span> Mantenimiento de Zonas</h1>
                  <button
        ...
        <CreateZonesForm v-if="isCreateFormVisible" @close="closeCreateForm" />
      </div>
    </div>
  </template>
  ...
  <script>
  import { ref } from 'vue';
  import DataTable from '@/components/zones/DataTable.vue';
  import CreateZonesForm from '@/components/zones/CreateZonesForm.vue';
