<template>
    ...
    <div class="pt-0 mt-0 pb-10 ml-0 mr-0 min-w-max[100%]">
      <div>
        <div class="flex justify-between items-center mb-2 bg-gray-50 p-6 rounded-lg shadow-lg">
                  ...
                  <h1 class="font-bold lg:text-2xl text-xl text-indigo-900 " >      <span class="mdi mdi-steering"></span> Mantenimiento de Conductores </h1>
        ...
        <CreateDriversForm v-if="isCreateFormVisible" @close="closeCreateForm" />
      </div>
    </div>
  </template>
  ...
  <script>
  import { ref } from 'vue';
  import DataTable from '@/components/drivers/DataTable.vue';
  import CreateDriversForm from '@/components/drivers/CreateDriverForm.vue';
